		...
		<div class="main my-partner">
			<div class="unionpay-pay">
				...
				<div class="unionpay-pay-proportion" style="padding-top: 20px;">
				    <ul>
						...
						<li><input type="text" v-model="param1"/><span>1~3(元)</span></li>
					</ul>
				</div>	
			</div>
			...
			<div class="VerticalMenu-top">
				<div class="VerticalMenu">
					<div>
						<div class="VerticalMenu-box"><span>D0阶梯结算底价(单位：万元)</span><i class="fa fa-angle-right"></i></div>
			...
			<div class="FenRun-details">
			    <p>设置返现参数</p>
				<ul>
				    <li><div class="FenRun-details-left">激活返现</div><div class="FenRun-details-right"><input type="text" v-model="amountA"/><span>0~{{jhCashback}} (元)</span></div></li>
					<li><div class="FenRun-details-left">VIP返现(90天)</div><div class="FenRun-details-right"><input type="text" v-model="amount_b"/><span>0~{{vipFive}} (元)</span></div></li>
					<li><div class="FenRun-details-left">VIP返现(150天)</div><div class="FenRun-details-right"><input type="text" v-model="amount_c"/><span>0~{{vipNine}} (元)</span></div></li>
					<li><div class="FenRun-details-left">活动返现</div><div class="FenRun-details-right"><input type="text" v-model="amount_d"/><span>0~{{activityCashback}} (元)</span></div></li>
				</ul>
