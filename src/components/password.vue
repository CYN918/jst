<template>
	<div class="box">
        ...
        <div class="form">
            ...
            <div class="active"><label>图形验证码</label><input style="width: 30%;" type="text" placeholder="请输图形验证码" v-model="captchaImage"/><img class="Img" id="Img" @click="refreshCaptcha()" src='http://120.24.160.251:8080/application/imgCode?+ Math.random()'/></div>
            <div>
                <label>短信验证码</label>
