<template>
    <div class="contain">
		<div class="head">
			<router-link to="/setRate" class="back"><i class="icon-back"></i></router-link>
			<span class="title">分润参数</span>
			<a @click="butClick" style="float: right;color: #FF6A48;font-size: 14px;padding-right: 14px;">修改参数</a>
		</div>
		<div class="main my-partner">
			...
			<div class="FenRun-details">
			    <p>设置返现参数</p>
				<ul>
				    <li><div class="FenRun-details-left">激活返现</div><div class="FenRun-details-right">{{activation}}(元)</div></li>
					<li><div class="FenRun-details-left">VIP返现(90天)</div><div class="FenRun-details-right">{{Vipcash}}(元)</div></li>
					<li><div class="FenRun-details-left">VIP返现(150天)</div><div class="FenRun-details-right">{{Vipback}}(元)</div></li>
					<li><div class="FenRun-details-left">活动返现</div><div class="FenRun-details-right">{{activity}}(元)</div></li>
				</ul>
...
export default {
	...
	methods: {
		...
		butClick(){
			this.$router.push({name: 'MentallyVersion',params:{id: '2'}});
		}
	},
	mounted () {
